...
- `references/3ms-framework.md` — the framework (used to quote principles back), if present
...
- **Dry run on a populated OS** with no prompt. Expected: skill surfaces 2-3 candidates pulled from the user's recent activity, priorities, and top pain. Generic output ("you should build a brief") = fail.
