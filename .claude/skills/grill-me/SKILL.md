...
- If a question can be answered by **reading a file or doc** the user already has, do that instead of asking. If the user hands you a doc, read it and only surface what's net-new.
